...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateChapterTime, calculateCourseDuration, calculateNoOfLectures, currency, isAlreadyEnrolled} = useContext(AppContext)
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
        ...
        <div className='py-20 text-sm md:text-default'>
          <h3 className='text-xl font-semibold text-gray-800'>Course Descripsion</h3>
